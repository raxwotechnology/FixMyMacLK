...
const DELETED_PRODUCTS_API = 'https://fixmymaclk-2kww.onrender.com/api/products/deleted';
const DELETION_LOGS_API = 'https://fixmymaclk-2kww.onrender.com/api/products/deleted-logs';
const INACTIVE_PRODUCTS_API = 'https://fixmymaclk-2kww.onrender.com/api/products/inactive';
