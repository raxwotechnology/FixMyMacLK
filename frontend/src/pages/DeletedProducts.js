...
const PRODUCTS_API = 'https://fixmymaclk.onrender.com/api/products';
const DELETED_PRODUCTS_API = 'https://fixmymaclk.onrender.com/api/products/deleted';
const DELETION_LOGS_API = 'https://fixmymaclk.onrender.com/api/products/deleted-logs';
const INACTIVE_PRODUCTS_API = 'https://fixmymaclk.onrender.com/api/products/inactive';
