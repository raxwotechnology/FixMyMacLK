...
const API_URL = "https://fixmymaclk.onrender.com/api/dashboard";
const PRODUCTS_REPAIR_API_URL = 'https://fixmymaclk.onrender.com/api/productsRepair';
const EXTRA_INCOME_API_URL = 'https://fixmymaclk.onrender.com/api/extra-income';
const SALARIES_API_URL = 'https://fixmymaclk.onrender.com/api/salaries';
const MAINTENANCE_API_URL = 'https://fixmymaclk.onrender.com/api/maintenance';
const PAYMENTS_API_URL = 'https://fixmymaclk.onrender.com/api/payments/forsummery';
const PRODUCTS_API_URL = 'https://fixmymaclk.onrender.com/api/products';
const SUPPLIERS_API_URL = 'https://fixmymaclk.onrender.com/api/suppliers';
