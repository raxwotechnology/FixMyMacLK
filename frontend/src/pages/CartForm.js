...
const API_URL = 'https://fixmymaclk.onrender.com/api/suppliers';
...
const CartForm = ({ supplier, item, closeModal, darkMode, refreshProducts }) => {
  ...
  const fetchNames = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://fixmymaclk.onrender.com/api/product-uploads`, {
      });

      // const response = await axios.get('https://fixmymaclk.onrender.com/api/products', {
      //   headers: {
