...
const API_URL = "https://fixmymaclk.onrender.com/api/bank-passbook";
const PRODUCTS_REPAIR_API_URL = "https://fixmymaclk.onrender.com/api/productsRepair"; // Adjust if needed
